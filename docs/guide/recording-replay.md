...
- Understand the recording file format
- Edit recordings to add assertions
...
Every recording starts with metadata:

```yaml
metadata:
  version: "1.0"              # Recording format version
...
- ✅ Understand the YAML recording format
